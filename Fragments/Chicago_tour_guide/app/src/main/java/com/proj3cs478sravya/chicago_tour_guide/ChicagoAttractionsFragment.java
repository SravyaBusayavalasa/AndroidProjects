...
public class ChicagoAttractionsFragment extends android.app.ListFragment {
        ...
        public void onAttach(Context activity) {
            ...
            try {
                ...
                // Set the SelectionListenerfor communicating with the QuoteViewerActivity
        ...
        public void onActivityCreated(Bundle savedState) {
            ...
            setListAdapter(new ArrayAdapter<String>(getActivity(),
                    R.layout.ar_list, MainActivity.attractions_array));
